      ...
      <div className="container">
        ...
        <div className="grid grid-cols-4 gap-8 max-lg:grid-cols-2 max-md:grid-cols-1 mt-10 max-md:gap-4">
          {cards?.map((item: any, index: number) => (
            <BlurStagger
              key={index}
              className="relative border border-dashed border-gray-500 p-4.5 rounded-lg bg-black/60 overflow-hidden"
            >
              ...
              <BlurStagger className="w-max">
                <motion.h4 variants={blurChild} className="mb-2 text-gray-300">
                  {item.title}
                </motion.h4>
